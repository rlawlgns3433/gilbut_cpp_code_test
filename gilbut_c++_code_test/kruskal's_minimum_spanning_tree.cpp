...
//
//	auto& edges() const { return edge_list; } // 모든 에지 반환
//
//	
//	auto edges(unsigned v) const {	//v에서 나가는 모든 에지 반환
...
//		if (e.src >= 1 && e.src <= V && e.dst >= 1 && e.dst <= V) {	//유효 에지인지 확인
//			edge_list.emplace_back(e);
//		}
//		else cerr << "에러 : 유효 범위를 벗어난 정점" << endl;
//	}
//	
//	template<typename U>
...
//
//	
//	for (auto& e : G.edges()) { //모든 에지를 최소힙에 추가
//		edge_min_heap.push(e);
//	}
//
//	auto N = G.vertices(); // 정점 개수에 해당하는 크기의 디스조인트셋 자료구조 생성 및 초기화
